...
public class ExcelUtil {
	 ...
	 * @throws IOException
	 */
	public static void export(String excelName, String sheetName, String[] headers, String[] ds_titles, int[] ds_format, int[] widths, List<Map<String, Object>> data, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 设置文件名
		String fileName = "";
		if (null != excelName && excelName.length() > 0) {
			fileName = excelName;
		}
		// 创建一个工作薄
		...
		String filename = encodeChineseDownloadFileName(request, fileName);
